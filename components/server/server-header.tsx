          ...
          <DropdownMenu>
            ...
            >
                <button
                    ...
                    h-12 border-neutral-200 dark:border-neutral-700 border-b-2
            ...
            <DropdownMenuContent className="w-56 text-xs font-medium text-black dark:text-neutral-400 space-y-[2px]" >
             {isModerator && (
                 ...
                 className=" text-zinc-900 dark:text-zinc-100/70 px-3 py-2 text-sm cursor-pointer">
                    Invite People
             ...
             {isModerator && (
                 ...
                 className="px-3 py-2 text-rose-500/90 text-sm cursor-pointer">
                   Delete Server
